...
function getArsenalPlayer() {
    ...
    teamName.innerHTML = "Arsenal TEAM <br> <img src='./arsenal.png' width='100'>";
    teamName.style = "text-align:center; margin-bottom:30px; color:black";
...
function getManCityPlayer() {
    footer.children[0].innerHTML = "";
    teamName.innerHTML = "Manchester City TEAM  <br> <img src='./manchester-city.png' width='100'>";
    teamName.style = "text-align:center; margin-bottom:30px; color:black";
    footer.append(teamName);
    mainList.innerHTML = "";
    players.forEach((item, index) => {
...
function getManUnitedPlayer() {
    footer.children[0].innerHTML = "";
    teamName.innerHTML = "Manchester United TEAM <br> <img src='./manchester-united.png' width='100'>";
    teamName.style = "text-align:center; margin-bottom:30px; color:black";
    mainList.innerHTML = "";
    footer.append(teamName);
    players.forEach((item, index) => {
...
function getTotenhamPlayer() {
    footer.children[0].innerHTML = "";
    teamName.innerHTML = "Tottenham TEAM <br> <img src='./tottenham-hotspur.png' width='100'>";
    teamName.style = "text-align:center; margin-bottom:30px; color:black";
    mainList.innerHTML = "";
    footer.append(teamName);
    players.forEach((item, index) => {
...
function getWestBornPlayer() {
    footer.children[0].innerHTML = "";
    teamName.innerHTML = "West Brom TEAM <br> <img src='./atletico-de-madrid.png' width='100'>";
    teamName.style = "text-align:center; margin-bottom:30px; color:black";
    mainList.innerHTML = "";
    footer.append(teamName);
    players.forEach((item, index) => {
...
function getAllPlayer() {
    footer.children[0].innerHTML = "";
    teamName.innerHTML = "ALL TEAM <br> <img src='./arsenal.png' width='100'>  <img src='./manchester-city.png' width='100'>  <img src='./manchester-united.png' width='100'>  <img src='./tottenham-hotspur.png' width='100'>  <img src='./atletico-de-madrid.png' width='100'>";
    teamName.style = "text-align:center; margin-bottom:30px; color:black";
    mainList.innerHTML = "";
    footer.append(teamName);
    players.forEach((item, index) => {
